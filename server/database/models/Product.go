...
type Product struct {
	...
	Price       float64          `gorm:"type:decimal(10,2);not null" validate:"required,gte=0" json:"price"`
	Stock       int              `gorm:"type:int;not null" validate:"required,min=0" json:"stock"`
	CategoryID  int64            `gorm:"not null" json:"category_id" validate:"required,numeric"`
