	...
	return (
		<div className="flex bg-primary justify-center items-start">
			<div className="flex max-w-screen-lg w-full">
				<div className="w-1/2 bg-white mt-40 drop-shadow-cartoon rounded-lg border border-black h-fit">
				...
				<div className="flex flex-col pr-10 items-end justify-center h-screen w-1/2">
					<div className="px-8 py-8 pb-40 mt-20 bg-white drop-shadow-cartoon rounded-lg border border-black">
						...
						<div className="text-2xl font-display mt-3 ml-9">
							Do you have a code?
						</div>
						{/* @ts-expect-error Async*/}
						<InputBox />
						<div className="flex justify-center">
							<button className="px-10 py-5 bg-sky-400 text-white rounded-lg absolute bottom-5">
								Checkout
							</button>
						</div>
					</div>
