...
export function useInventory() {
	...
	const addProduct = async (product: Product) => {
		...
		try {
			...
			setError(
				err.message ||
					"Failed to add product. Please check your network or try again.",
			)
		} finally {
			setLoading(false)
		}
	...
	const updateProduct = async (id: string, updatedProduct: Product) => {
		...
		try {
			...
			setError(
				err.message ||
					"Failed to update product. Please check your network or try again.",
			)
		} finally {
			setLoading(false)
		}
	...
	const deleteProduct = async (id: string) => {
		...
		try {
			...
			setError(
				err.message ||
					"Failed to delete product. Please check your network or try again.",
			)
		} finally {
			setLoading(false)
		}
