  ...
  return (
    <div className="min-h-screen bg-primary/25 py-6">
      <div className="container mx-auto px-6 flex flex-col md:flex-row gap-6">
        {/* Sidebar Navigation */}
        <aside className="w-full lg:w-1/5 p-4 rounded-2xl space-y-4 mb-6 lg:mb-0 h-fit border mr-4">
    <h2 className="text-xl font-bold mb-4">Admin Panel</h2>
    <div className="flex flex-col space-y-2">  
        <LinkButton to="/dashboard" text="Dashboard" buttonClassNames="w-full border-black bg-primary text-black transition-all duration-200 ease-in-out hover:bg-primary-dark hover:shadow-[4px_4px_0px_black]" />
        <LinkButton to="/admin/orders" text="Orders" buttonClassNames="w-full border-black bg-primary text-black transition-all duration-200 ease-in-out hover:bg-primary-dark hover:shadow-[4px_4px_0px_black]" />
        <LinkButton to="/admin/inventory" text="Inventory" buttonClassNames="w-full border-black bg-primary text-black transition-all duration-200 ease-in-out hover:bg-primary-dark hover:shadow-[4px_4px_0px_black]" />
        <LinkButton to="/admin/reports" text="Reports" buttonClassNames="w-full border-black bg-primary text-black transition-all duration-200 ease-in-out hover:bg-primary-dark hover:shadow-[4px_4px_0px_black]" />
        <LinkButton to="/admin/settings" text="Settings" buttonClassNames="w-full border-black bg-primary text-black transition-all duration-200 ease-in-out hover:bg-primary-dark hover:shadow-[4px_4px_0px_black]" />
    </div>
    </aside>
